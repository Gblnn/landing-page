...
export default function NewsBox(props:Props){
    return(
        ...
        <div className='project' style={{ border:"1px solid rgba(100 100 100/ 40%)", borderRadius:"1.5rem", display:"flex", flexFlow:"row", padding:"0.5rem", background:"rgba(100 100 100/ 10%)", boxShadow:"1px 1px 10px rgba(0 0 0/ 50%)", width:""}}>
            
            <img className='project-img' src={props.img} style={{objectFit:"cover", borderRadius:"1rem", borderTopRightRadius:0, borderBottomRightRadius:0, border:"", width:"10ch", height:"15ch"}} />
