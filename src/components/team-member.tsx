...
export default function TeamMember(){
    return(
        <div className="project" style={{background:"rgba(100 100 100/ 20%)", width:"36ch", height:"12ch", borderRadius:"1.5rem", display:"flex", alignItems:"center"}}>
            ...
            <div style={{height:"100%",flex:1, border:"", display:"flex", justifyContent:"center", flexFlow:"column", paddingRight:"1rem"}}>
                ...
                <p style={{fontWeight:600, color:"dodgerblue", fontSize:"0.8rem"}}>Designation of Member</p>
