  ...
  export function NavMenu(props:Props) {
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" style={{marginLeft:"0.5rem", marginBottom:"1.75rem", width:"10rem"}}>
          ...
          <DropdownMenuGroup>
            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuPortal>
                <DropdownMenuSubContent style={{margin:"0.75rem", width:"12rem", marginBottom:"4.65rem"}}>
                ...
                <a
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground" style={{color:"white", opacity:"0.5"}}>
